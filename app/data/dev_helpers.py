...
'''
import json
from app.entities import DistrictCase, DocketEntry, Case, RecordOnAppeal, RecordOnAppealDocketEntry
...
class CaseDevUtil:
    def delete_all(self, db: Session) -> bool:
        ...
        db.query(RecordOnAppealDocketEntry).delete()
        db.query(RecordOnAppeal).delete()
    ...
    def add_seed_cases(self, db: Session) -> bool:
        ...
        db.execute("ALTER SEQUENCE records_on_appeal_id_seq RESTART WITH 1")
        db.execute("ALTER SEQUENCE roa_docket_entry_id_seq RESTART WITH 1")
