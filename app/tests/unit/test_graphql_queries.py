...
from app.api.graph_ql.resolvers.query import resolve_case, resolve_roa


@patch('app.api.graph_ql.resolvers.query.case')
...
@patch('app.api.graph_ql.resolvers.query.record_on_appeal')
